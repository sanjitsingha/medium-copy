      ...
      <div className="sticky top-[64px] z-40 bg-white/95 backdrop-blur-md flex flex-col w-full border-b border-gray-200">
        ...
        <div className="relative w-full overflow-hidden">
          ...
          >
            ...
            {/* Block Level Buttons */}
            <button className={`w-8 h-8 flex items-center justify-center rounded shrink-0 font-bold font-creato text-sm transition-colors ${fmt.block === 'p' ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black'}`} onMouseDown={e => { e.preventDefault(); toggleBlock("p"); }} title="Paragraph">P</button>
            <button className={`w-8 h-8 flex items-center justify-center rounded shrink-0 font-bold font-creato text-sm transition-colors ${fmt.block === 'h1' ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black'}`} onMouseDown={e => { e.preventDefault(); toggleBlock("h1"); }} title="Heading 1">H1</button>
            <button className={`w-8 h-8 flex items-center justify-center rounded shrink-0 font-bold font-creato text-sm transition-colors ${fmt.block === 'h2' ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black'}`} onMouseDown={e => { e.preventDefault(); toggleBlock("h2"); }} title="Heading 2">H2</button>
            <button className={`w-8 h-8 flex items-center justify-center rounded shrink-0 font-bold font-creato text-sm transition-colors ${fmt.block === 'h3' ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black'}`} onMouseDown={e => { e.preventDefault(); toggleBlock("h3"); }} title="Heading 3">H3</button>
            ...
            <button className="w-8 h-8 flex items-center justify-center rounded shrink-0 text-gray-600 hover:bg-gray-100 hover:text-black transition-colors" onMouseDown={e => { e.preventDefault(); openLinkModal(); }} title="Link">
