    ...
    <div className="relative min-h-[calc(100vh-64px)] w-full bg-white font-sans text-gray-900 pb-24">
      ...
      <div className="sticky top-[64px] z-40 bg-white/95 backdrop-blur-md flex flex-col w-full border-b border-gray-200">
        ...
        <div className="relative w-full overflow-hidden">
          ...
          <div ref={toolbarRef} className="flex items-center justify-start sm:justify-center gap-1.5 px-4 sm:px-10 py-2 w-full overflow-x-auto hide-scrollbar scroll-smooth">
            <button className={`w-8 h-8 flex items-center justify-center rounded shrink-0 transition-colors ${fmt.bold ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black'}`} onMouseDown={e => { e.preventDefault(); run("bold"); }} title="Bold"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z"></path><path d="M6 12h9a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z"></path></svg></button>
            <button className={`w-8 h-8 flex items-center justify-center rounded shrink-0 transition-colors ${fmt.italic ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black'}`} onMouseDown={e => { e.preventDefault(); run("italic"); }} title="Italic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="19" y1="4" x2="10" y2="4"></line><line x1="14" y1="20" x2="5" y2="20"></line><line x1="15" y1="4" x2="9" y2="20"></line></svg></button>
            <button className={`w-8 h-8 flex items-center justify-center rounded shrink-0 transition-colors ${fmt.underline ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black'}`} onMouseDown={e => { e.preventDefault(); run("underline"); }} title="Underline"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 3v7a6 6 0 0 0 6 6 6 6 0 0 0 6-6V3"></path><line x1="4" y1="21" x2="20" y2="21"></line></svg></button>
            <button className={`w-8 h-8 flex items-center justify-center rounded shrink-0 transition-colors ${fmt.strike ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black'}`} onMouseDown={e => { e.preventDefault(); run("strikeThrough"); }} title="Strikethrough"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4H9a3 3 0 0 0-2.83 4"></path><path d="M14 12a4 4 0 0 1 0 8H6"></path><line x1="4" y1="12" x2="20" y2="12"></line></svg></button>
            ...
            <div className="w-px h-5 bg-gray-200 mx-1.5 shrink-0" />
            <button className={`w-8 h-8 flex items-center justify-center rounded shrink-0 transition-colors ${fmt.block === 'blockquote' ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black'}`} onMouseDown={e => { e.preventDefault(); toggleBlock("blockquote"); }} title="Quote"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" /></svg></button>
            <button className={`w-8 h-8 flex items-center justify-center rounded shrink-0 transition-colors ${fmt.block === 'pre' ? 'bg-gray-200 text-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black'}`} onMouseDown={e => { e.preventDefault(); toggleBlock("pre"); }} title="Code Block"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg></button>
            <div className="w-px h-5 bg-gray-200 mx-1.5 shrink-0" />
